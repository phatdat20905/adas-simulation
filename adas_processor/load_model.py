...
# Khởi tạo models
# =======================
model_coco = YOLO(MODEL_COCO)   # phát hiện người, xe, đèn giao thông
model_sign = YOLO(MODEL_SIGN)   # phát hiện biển báo VN
...
# Bộ nhớ theo dõi khoảng cách
last_distances = {}   # {id: (distance, timestamp)}
...
while True:
    ...
    if res.boxes is not None:
        for b in res.boxes:
            ...
            # Vẽ bounding box cho COCO
            cv2.rectangle(vis, (x1,y1), (x2,y2), color, 2)
            draw_label(vis, label, x1, y1, color)

    # ---- 2. Nhận diện biển báo bằng model best.pt ----
